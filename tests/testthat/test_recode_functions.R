...
test_that("population units correctly recoded", {
  ...
  expect_match(recode_population_units("number of map 1x1km grid cells"), "grids1x1")
  expect_match(recode_population_units("number of 1x1km grid cells"), "grids1x1")
  ...
  expect_match(recode_population_units("number of occupied trees"), "trees")
